...
(
    ...
    body2       varchar(100)  comment '响应体 rest:"rsp_body"',
    pre_hi      varchar(60) comment 'hi',
    post_bye    varchar(60) comment 'bye',
    bizdesc     varchar(60) comment '响应体 rest:"fix_desc"'
) engine = innodb
...
(
    ...
    rsp         varchar(60) comment '响应体 rest:"rsp_body"',
    dtoid       varchar(60) comment '响应体 rest:"rsp_json_id"'
) engine = innodb
...
(
    ...
    cost    int comment '费时毫秒',
    name    varchar(60) comment '响应体 rest:"custom_name"'
) engine = innodb
...
(
    ...
    fork_id      bigint comment '日志记录ID rest:"id,fork"',
    req_url varchar(60) comment '请求url',
    fork varchar(60) comment '请求参数 rest:"req_json_forkName,fork"',
    tran varchar(60) comment '渠道流水 rest:"rsp_json_tran,fork"',
    channel varchar(60) comment '请求url, rest:"fix_channel,fork"',
    created datetime default current_timestamp comment '创建时间 rest:"-"',
    started datetime comment '请求时间 rest:"started,fork"',
    end     datetime comment '结束时间 rest:",fork"',
    cost    int comment '费时毫秒 rest:",fork"',
    name    varchar(60) comment '响应体 rest:"custom_name,fork"',
    req    varchar(300) not null default '0' comment '响应体 rest:"req_body,fork"',
    method  varchar(300) not null default '0' comment 'service方法名称 rest:"req_method,fork"',
    rsp    varchar(300) not null default '0' comment '响应体 rest:"rsp_body,fork"',
    error   varchar(300) not null default '0' comment '响应体 rest:",fork"'
) engine = innodb
  default charset = utf8mb4 comment 'biz_log_custom';
