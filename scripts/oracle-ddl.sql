...
comment on column biz_log.bizdesc is '响应体 rest:"fix_desc"';
...
comment on column biz_log_post.rsp is '响应体 rest:"rsp_body"';
comment on column biz_log_post.dtoid is '响应体 rest:"rsp_json_id"';
/
